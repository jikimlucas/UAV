...
import org.qcri.micromappers.uav.service.video.vget.vhs.VimeoParser;
import org.qcri.micromappers.uav.service.video.vget.vhs.YouTubeParser;
...
public class VGet {
    ...
    private static final Logger LOGGER = Logger.getLogger(VGet.class);
